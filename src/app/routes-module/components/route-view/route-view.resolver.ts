...
const getRoute = (id = 1): Route => {
  ...
  for (let j = 0; j < pointCount; j++) {
    ...
    const point: RoutePoint = {
      ...
      path_to_img: '',
      latLng: {
        lat: getRandomFloatNumber(46.351, 46.35),
        lng: getRandomFloatNumber(48.041, 48.04),
      },
    };
    points.push(point);
  }
...
export class RouteViewResolver implements Resolve<Observable<Route>> {
